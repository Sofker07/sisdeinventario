...
<head>
    ...
    <title>BIENES LOCALIZADOS</title>
    <style>
        body {
    ...
    <div class="content">
        <div class="row">
            ...
            <div class="juntos">
                ...
                <p class="texto-titulo" style="margin-left: 140px"><strong>BIENES LOCALIZADOS</strong></p>
            </div>
        </div>
        <br><br>
        <div class="row">
        ...
        <div class="row">
            <table>
                ...
                <tbody>
                    <?php $total_activos=0;?>
                    @foreach ($localizados as $localizado)
                        <tr>
                            <td>{{$localizado->inventario_nacional}}</td>
                            <td>{{$localizado->descripcion}}</td>
                            <td>{{$localizado->numero_de_serie}}</td>
                            <td>{{$localizado->marca}}</td>
                            <td>{{$localizado->modelo}}</td>
                            <td>{{$localizado->observaciones}}</td>
                            <td>{{$localizado->clave_ur}}</td>
                        </tr>
                        <?php $total_activos+=1;?>
                    @endforeach
                </tbody>
